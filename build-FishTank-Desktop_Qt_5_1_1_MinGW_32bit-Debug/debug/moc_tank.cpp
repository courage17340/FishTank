...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Tank_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 31, 6)
    ...
    "Tank\0customMouseMoveEvent\0\0x\0y\0showxy\0"
};
...
void Tank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->customMouseMoveEvent((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->showxy((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Tank::customMouseMoveEvent)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Tank::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Tank.data,
      qt_meta_data_Tank,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void Tank::customMouseMoveEvent(int _t1, int _t2)
{
